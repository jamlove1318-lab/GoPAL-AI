...
import { getPhysicalLocationProfile, type PhysicalLocationProfile } from './livingPhysicalLocationProfiles';
...
export type WorldConstructionKit={id:string;name:string;archetype:WorldArchetype;theme:WorldTheme;physicalProfile?:PhysicalLocationProfile;buildings:WorldBuildingDefinition[];props:WorldPropDefinition[];infrastructure:WorldInfrastructureDefinition[];infrastructureNetworks:WorldInfrastructureNetwork[];transport:WorldTransportDefinition[];gameplay:WorldGameplayDefinition[];characters:WorldCharacterDefinition[];entrances:WorldEntranceDefinition[];environment:WorldConstructionEnvironment;tags:string[];templateId?:string;availableObjectFamilies?:WorldObjectFamily[]};
export type WorldConstructionOverrides=Partial<Omit<WorldConstructionKit,'id'|'archetype'>>&{id?:string};
export type WorldConstructionPreset={archetype:WorldArchetype;theme:WorldTheme;atmosphere:WorldConstructionEnvironment['atmosphere'];tags:string[]};
export const WORLD_CONSTRUCTION_PRESETS:Record<WorldArchetype,WorldConstructionPreset>={village:{archetype:'village',theme:'emerald',atmosphere:'calm',tags:['settlement','community']},city:{archetype:'city',theme:'festival',atmosphere:'lively',tags:['urban','dense','transport']},campus:{archetype:'campus',theme:'coastal',atmosphere:'lively',tags:['education','learning']},forest:{archetype:'forest',theme:'emerald',atmosphere:'mysterious',tags:['nature','exploration']},mountain:{archetype:'mountain',theme:'mountain',atmosphere:'mysterious',tags:['nature','altitude']},coastal:{archetype:'coastal',theme:'coastal',atmosphere:'calm',tags:['water','harbor','travel']},fantasy:{archetype:'fantasy',theme:'festival',atmosphere:'fantasy',tags:['fantasy','magic','adventure']},scifi:{archetype:'scifi',theme:'coastal',atmosphere:'futuristic',tags:['scifi','technology','space']},'game-level':{archetype:'game-level',theme:'festival',atmosphere:'lively',tags:['game','challenge','replay']}};
export function constructionPreset(archetype:WorldArchetype){return WORLD_CONSTRUCTION_PRESETS[archetype];}
...
export function createWorldConstructionKit(base:Omit<WorldConstructionKit,'id'>&{id?:string}):WorldConstructionKit{return{id:base.id??`${base.archetype}-${base.theme}`,name:base.name,archetype:base.archetype,theme:base.theme,physicalProfile:base.physicalProfile,buildings:[...base.buildings],props:[...base.props],infrastructure:[...base.infrastructure],infrastructureNetworks:[...base.infrastructureNetworks],transport:[...base.transport],gameplay:[...base.gameplay],characters:[...base.characters],entrances:[...base.entrances],environment:{...base.environment},tags:[...base.tags],templateId:base.templateId,availableObjectFamilies:base.availableObjectFamilies?[...base.availableObjectFamilies]:undefined};}
export function composeWorldConstructionKit(base:WorldConstructionKit,overrides:WorldConstructionOverrides):WorldConstructionKit{return{...base,...overrides,id:overrides.id??base.id,buildings:overrides.buildings?[...overrides.buildings]:[...base.buildings],props:overrides.props?[...overrides.props]:[...base.props],infrastructure:overrides.infrastructure?[...overrides.infrastructure]:[...base.infrastructure],infrastructureNetworks:overrides.infrastructureNetworks?[...overrides.infrastructureNetworks]:[...base.infrastructureNetworks],transport:overrides.transport?[...overrides.transport]:[...base.transport],gameplay:overrides.gameplay?[...overrides.gameplay]:[...base.gameplay],characters:overrides.characters?[...overrides.characters]:[...base.characters],entrances:overrides.entrances?[...overrides.entrances]:[...base.entrances],environment:{...base.environment,...(overrides.environment??{})},tags:overrides.tags?[...overrides.tags]:[...base.tags],templateId:overrides.templateId??base.templateId,physicalProfile:overrides.physicalProfile??base.physicalProfile,availableObjectFamilies:overrides.availableObjectFamilies?[...overrides.availableObjectFamilies]:base.availableObjectFamilies?[...base.availableObjectFamilies]:undefined};}
export function cloneConstructionKit(kit:WorldConstructionKit,id=`${kit.id}-copy`){return composeWorldConstructionKit(kit,{id});}
export function buildWorldConstructionKit(locationId:string):WorldConstructionKit{const location=getLivingLocationTemplate(locationId);const archetype=inferArchetype(location.id);const preset=constructionPreset(archetype);const template=getWorldTemplate(`${archetype}-template`);const physicalProfile=getPhysicalLocationProfile(locationId)??undefined;return createWorldConstructionKit({id:location.id,name:location.name,archetype,theme:location.theme,physicalProfile,buildings:location.buildings,props:location.props,infrastructure:getWorldInfrastructure(location.id),infrastructureNetworks:getWorldInfrastructureNetworks(location.id),transport:getLivingWorldTransport(location.id),gameplay:getLocationGameplay(location.id),characters:getWorldCharacters(location.id),entrances:getWorldEntrances(location.id),environment:{dayNight:true,weather:true,seasons:true,ambientAnimation:true,atmosphere:preset.atmosphere},tags:[...preset.tags,'living-world',location.theme,archetype,...(template?.preset.tags??[])],templateId:template?.id,availableObjectFamilies:['building','interior','terrain','decoration','infrastructure','transportation','character','gameplay','fantasy','scifi','city','nature']});}
