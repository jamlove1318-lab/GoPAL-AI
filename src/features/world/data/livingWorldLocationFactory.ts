...
/** Builds a physical location from reusable primitives. World identity remains separate from location construction. */
export function buildWorldLocation(locationId:string):WorldLocationDefinition{
 ...
 return{...base,worldKind:'home',languageWorldId:'emerald-valley',metadata:{...(base.metadata??{}),languageWorldId:'emerald-valley',worldDisplayName:'Emerald Valley'}};
}
