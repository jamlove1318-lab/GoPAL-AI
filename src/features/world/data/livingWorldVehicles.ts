...
export const LIVING_WORLD_VEHICLES:Record<string,WorldVehicleDefinition[]>={
 'emerald-village':[
  {id:'emerald-train-01',kind:'train',x:5,y:92,scale:.9,theme:'emerald',routeId:'emerald-rail-loop',speed:.45,moving:true,interactive:true,label:'Valley Train',networkId:'emerald-railway'},
  {id:'emerald-bus-01',kind:'bus',x:8,y:60,scale:.8,theme:'emerald',routeId:'emerald-bus-loop',speed:.35,moving:true,interactive:true,label:'Village Bus',networkId:'emerald-road-main'}
 ],
...
export const LIVING_WORLD_VEHICLE_ROUTES:Record<string,WorldVehicleRoute[]>={
 'emerald-village':[route('emerald-rail-loop','train',.45,transportFallback('emerald-village','track',[{x:5,y:92},{x:28,y:40},{x:55,y:38},{x:82,y:34},{x:105,y:32,waitMs:500}]),'emerald-railway'),route('emerald-bus-loop','bus',.35,[{x:8,y:60},{x:30,y:56},{x:54,y:52},{x:78,y:46},{x:101,y:42,waitMs:700}],'emerald-road-main')],
