...
export type WorldCinematicAnchors={landmarkObjectId?:string;residentObjectId?:string;transportObjectId?:string;environmentObjectId?:string;departureObjectId?:string};
...
export type WorldLocationDefinition={id:string;name:string;theme:WorldTheme;templateId?:string;description?:string;objects:WorldObjectDefinition[];environment?:WorldEnvironmentRules;rules?:WorldLocationRules;tags?:string[];metadata?:Record<string,unknown>;cinematicAnchors?:WorldCinematicAnchors;worldKind?:WorldContainerKind;languageWorldId?:string;language?:string;locale?:string};
export function createWorldLocation(location:WorldLocationDefinition):WorldLocationDefinition{return{...location,objects:[...location.objects],tags:location.tags?[...location.tags]:[],cinematicAnchors:location.cinematicAnchors?{...location.cinematicAnchors}:undefined};}
