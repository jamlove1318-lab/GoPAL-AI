...
/** Full-screen living-world surface. No dashboard cards or navigation shell. */
export function LivingValleyScreen(_props:Props){
 ...
 useEffect(()=>{const tick=()=>{const now=new Date();setWorldTime(now);runtime.tick(now.getTime());};tick();const id=setInterval(tick,250);return()=>clearInterval(id);},[runtime]);
