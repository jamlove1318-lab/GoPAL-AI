...
/** Archived visual composition retained for future reuse; not part of active Emerald Valley rendering. */
export function LegacyLivingWorldVisualLayer({ theme='emerald', time='afternoon' }: { theme?: WorldTheme; time?: 'morning'|'afternoon'|'evening'|'night' }) {
