...
export const LIVING_BUILDINGS: GameWorldBuilding[] = [
  { id: 'sanctuary', x: 12, y: 70, scale: .95, interactionRadius: 11, collisionWidth: 15, collisionHeight: 11 },
  { id: 'cafe', x: 47, y: 38, scale: 1.05, interactionRadius: 11, collisionWidth: 16, collisionHeight: 11 },
  { id: 'library', x: 73, y: 20, scale: .92, interactionRadius: 11, collisionWidth: 15, collisionHeight: 11 },
  { id: 'market', x: 78, y: 67, interactionRadius: 11, collisionWidth: 16, collisionHeight: 11 },
  { id: 'garden', x: 31, y: 79, scale: .9, interactionRadius: 9, collisionWidth: 13, collisionHeight: 9 },
];
