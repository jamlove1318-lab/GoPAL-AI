...
/** Canonical learner-scoped store for persistent living objects in the World. */
export const livingWorldObjectsStore = {
  ...
  /** Explicit legacy migration for the single local explorer identity only. */
